...
Shader "Shader Forge/U_Y_AP_1" {
    Properties {
        ...
        _X_copy ("X_copy", Range(-1, 1)) = 0
        _Y_copy ("Y_copy", Range(-1, 1)) = 0
        _tex2 ("tex2", 2D) = "white" {}
    ...
    SubShader {
        ...
        Pass {
            ...
            // #pragma only_renderers glcore gles metal 
            // #pragma target 3.0
