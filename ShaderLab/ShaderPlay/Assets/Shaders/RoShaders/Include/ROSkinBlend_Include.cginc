...
#include "ROCommonHead_Include.cginc"
...
inline fixed4 BlendColor(in v2f i)
{
    ...
    return i.uv0.x < 1 ? tex2D(_Tex0, i.uv0 - uvOffset):
        i.uv0.x < 2 ? tex2D(_Tex1, i.uv0-uvOffset):
	    i.uv0.x < 3 ? ChangeEyesColor(_Tex2, _Tex2, i.uv0, i.uv1, uvOffset, _EyesColor) :
        i.uv0.x < 4 ? tex2D(_Tex3, i.uv0-uvOffset):
        i.uv0.x < 5 ? tex2D(_Tex4, i.uv0-uvOffset):
	    i.uv0.x < 6 ? tex2D(_Tex5, i.uv0-uvOffset):
        i.uv0.x < 7 ? tex2D(_Tex6, i.uv0 - uvOffset) : ChangeHairColor(_Tex0, _Tex7, i.uv0, i.uv0, uvOffset, _HairColor);
}
